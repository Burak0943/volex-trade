  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-black text-white">
      <form onSubmit={handleSubmit} className="w-full max-w-md p-8 bg-slate-800/60 rounded-lg shadow-xl">
        <h2 className="text-2xl font-bold mb-6">Create your ChartFlow account</h2>
        ...
        <button type="submit" className="w-full py-2 px-4 rounded bg-amber-500 hover:bg-amber-600 text-black font-semibold" disabled={loading}>
